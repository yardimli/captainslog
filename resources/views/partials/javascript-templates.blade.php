        ...
        <section class="fixed max-h-[80dvh] w-full max-w-md overflow-y-auto rounded-2xl border border-slate-300 bg-white p-4 shadow-2xl ring-1 ring-slate-950/5 dark:border-slate-700 dark:bg-slate-900 dark:ring-white/10" role="dialog" aria-modal="true" aria-label="Choose time" data-time-dialog-panel>
            ...
            <div class="time-wheel-frame overflow-hidden rounded-xl border border-slate-200 bg-slate-50 shadow-inner dark:border-slate-700 dark:bg-slate-950">
                ...
                <div class="time-wheel-grid relative grid grid-cols-2" data-time-wheel-grid>
                    ...
                    <div class="time-wheel-column relative border-r border-slate-200 dark:border-slate-700" data-time-wheel-column>
                        <button type="button" class="absolute inset-x-2 top-1 z-30 flex h-8 items-center justify-center rounded-lg bg-white/90 text-slate-600 shadow-sm hover:bg-indigo-100 hover:text-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-slate-900/90 dark:text-slate-300 dark:hover:bg-indigo-950" data-time-wheel-step="-1" aria-label="Previous hour"><svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="m6 15 6-6 6 6"/></svg></button>
                        <div class="time-wheel relative z-10 h-72 snap-y snap-mandatory overflow-y-auto overscroll-contain touch-pan-y" style="padding-block:120px" role="listbox" aria-label="Hour" data-time-wheel-hour-24>
                        ...
                        <div class="time-wheel relative z-10 hidden h-72 snap-y snap-mandatory overflow-y-auto overscroll-contain touch-pan-y" style="padding-block:120px" role="listbox" aria-label="Hour" data-time-wheel-hour-12>
                        ...
                        <button type="button" class="absolute inset-x-2 bottom-1 z-30 flex h-8 items-center justify-center rounded-lg bg-white/90 text-slate-600 shadow-sm hover:bg-indigo-100 hover:text-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-slate-900/90 dark:text-slate-300 dark:hover:bg-indigo-950" data-time-wheel-step="1" aria-label="Next hour"><svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="m6 9 6 6 6-6"/></svg></button>
                    </div>
                    <div class="time-wheel-column relative border-r border-slate-200 dark:border-slate-700" data-time-wheel-column>
                        <button type="button" class="absolute inset-x-2 top-1 z-30 flex h-8 items-center justify-center rounded-lg bg-white/90 text-slate-600 shadow-sm hover:bg-indigo-100 hover:text-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-slate-900/90 dark:text-slate-300 dark:hover:bg-indigo-950" data-time-wheel-step="-1" aria-label="Previous minute"><svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="m6 15 6-6 6 6"/></svg></button>
                        <div class="time-wheel relative z-10 h-72 snap-y snap-mandatory overflow-y-auto overscroll-contain touch-pan-y" style="padding-block:120px" role="listbox" aria-label="Minute" data-time-wheel-minute>
                        ...
                        <button type="button" class="absolute inset-x-2 bottom-1 z-30 flex h-8 items-center justify-center rounded-lg bg-white/90 text-slate-600 shadow-sm hover:bg-indigo-100 hover:text-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-slate-900/90 dark:text-slate-300 dark:hover:bg-indigo-950" data-time-wheel-step="1" aria-label="Next minute"><svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="m6 9 6 6 6-6"/></svg></button>
                    </div>
                    <div class="time-wheel-column relative hidden" data-time-wheel-column data-time-wheel-period-column>
                        <button type="button" class="absolute inset-x-2 top-1 z-30 flex h-8 items-center justify-center rounded-lg bg-white/90 text-slate-600 shadow-sm hover:bg-indigo-100 hover:text-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-slate-900/90 dark:text-slate-300 dark:hover:bg-indigo-950" data-time-wheel-step="-1" aria-label="Previous period"><svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="m6 15 6-6 6 6"/></svg></button>
                        <div class="time-wheel relative z-10 h-72 snap-y snap-mandatory overflow-y-auto overscroll-contain touch-pan-y" style="padding-block:120px" role="listbox" aria-label="AM or PM" data-time-wheel-period>
                        ...
                        <button type="button" class="absolute inset-x-2 bottom-1 z-30 flex h-8 items-center justify-center rounded-lg bg-white/90 text-slate-600 shadow-sm hover:bg-indigo-100 hover:text-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-slate-900/90 dark:text-slate-300 dark:hover:bg-indigo-950" data-time-wheel-step="1" aria-label="Next period"><svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><path d="m6 9 6 6 6-6"/></svg></button>
                    </div>
                </div>
            </div>
        </section>
