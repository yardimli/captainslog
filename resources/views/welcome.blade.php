...
<head>
    ...
    <title>Total Log · Live guest demo</title>
    ...
    <main>
        <section class="relative overflow-hidden border-b border-slate-200 bg-slate-950 text-white dark:border-slate-800">
            ...
            <div id="landing-hero-content" class="relative mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.2fr_.8fr] lg:px-8 lg:py-24">
                <div id="landing-hero-copy" class="min-w-0"><p class="text-sm font-bold uppercase tracking-[.24em] text-indigo-300">Your days, kept with context</p><h1 class="mt-4 max-w-3xl break-words text-5xl font-black leading-[.95] sm:text-7xl">A total log of ordinary days.</h1><p class="mt-6 max-w-2xl text-lg leading-relaxed text-slate-300">Bring notes, recurring tasks, calendar events, reading, browsing, and desktop activity into one calm daily timeline. Add what matters yourself and let optional sensors fill in the context around it.</p><div class="demo-hero-actions mt-8 flex flex-wrap gap-3"><a href="#demo" class="btn">Try the live demo ↓</a><a href="#connected-sources" class="btn-secondary border-white/20 bg-white/10 text-white hover:bg-white/20">See connected sources</a></div></div>
                <div id="landing-demo-summary" class="min-w-0 self-end overflow-hidden rounded-3xl border border-white/10 bg-white/10 p-6 shadow-2xl backdrop-blur"><div id="landing-demo-count" class="flex min-w-0 items-center gap-3"><span class="grid h-11 w-11 shrink-0 place-items-center rounded-2xl bg-emerald-400 font-black text-slate-950">8</span><div id="landing-demo-count-copy" class="min-w-0"><p class="break-words font-bold">Eight everyday logs</p><p class="break-words text-sm text-slate-300">The previous seven days plus today</p></div></div><div id="landing-demo-preview-images" class="mt-5 grid grid-cols-2 gap-2"><img src="{{ asset('images/demo-dog-walk.png') }}" alt="A person walking their dog through a neighborhood park" class="aspect-[3/2] w-full rounded-xl object-cover"><img src="{{ asset('images/demo-language-study.png') }}" alt="A person studying a language at their kitchen table" class="aspect-[3/2] w-full rounded-xl object-cover"></div><div id="landing-demo-features" class="mt-6 min-w-0 space-y-3 text-sm text-slate-300"><p class="break-words">✓ A single timeline for manual and automatic entries</p><p class="break-words">✓ Private notes, photos, tasks, and AI-assisted reflection</p><p class="break-words">✓ A private guest workspace—no signup required</p></div></div>
            </div>
        </section>

        <section id="connected-sources" class="mx-auto max-w-7xl scroll-mt-6 px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
            <div class="demo-connected-heading max-w-3xl"><p class="text-xs font-bold uppercase tracking-[.2em] text-indigo-600">Connected sources</p><h2 class="mt-2 text-3xl font-black sm:text-4xl">Your day, without reconstructing it from memory.</h2><p class="mt-4 text-lg leading-relaxed text-slate-500">Total Log combines the entries you choose to write with small, privacy-conscious signals from the tools you already use.</p></div>
            <div class="demo-connected-grid mt-10 grid gap-5 lg:grid-cols-2">
                <article class="panel overflow-hidden border-indigo-200 bg-gradient-to-br from-indigo-50 to-white dark:border-indigo-900 dark:from-indigo-950/60 dark:to-slate-900"><div class="demo-connected-card-heading flex items-start gap-4"><span class="grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-indigo-600 text-2xl text-white">🌐</span><div class="demo-connected-card-copy"><p class="text-xs font-bold uppercase tracking-wider text-indigo-600">Chrome extension</p><h3 class="mt-1 text-2xl font-black">Browsing context, with the private parts removed.</h3></div></div><ul class="mt-6 space-y-3 text-sm leading-relaxed text-slate-600 dark:text-slate-300"><li>Tracks time on active website hostnames—never page paths, titles, queries, or ports.</li><li>Can summarize Chrome history synchronized from your other devices as mobile browsing visits.</li><li>Talks only to Total Log Desktop through a local bridge and shows a red exclamation badge if the desktop app is unavailable.</li></ul></article>
                <article class="panel overflow-hidden border-emerald-200 bg-gradient-to-br from-emerald-50 to-white dark:border-emerald-900 dark:from-emerald-950/50 dark:to-slate-900"><div class="demo-connected-card-heading flex items-start gap-4"><span class="grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-emerald-600 text-2xl text-white">🖥️</span><div class="demo-connected-card-copy"><p class="text-xs font-bold uppercase tracking-wider text-emerald-700">Windows desktop app</p><h3 class="mt-1 text-2xl font-black">Application time collected in useful batches.</h3></div></div><ul class="mt-6 space-y-3 text-sm leading-relaxed text-slate-600 dark:text-slate-300"><li>Collects foreground application activity locally and sends one batch every five minutes.</li><li>Shows per-app totals for the last five minutes, last hour, and today.</li><li>Receives Chrome data, reports connection health, and keeps sensors available from the system tray.</li></ul></article>
            </div>
            <div class="demo-connected-small-grid mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <article class="panel"><span class="text-2xl">📖</span><h3 class="mt-3 font-black">Manual Kindle log</h3><p class="mt-2 text-sm leading-relaxed text-slate-500">Open your signed-in Kindle Cloud Reader and log the first recent book’s title and author only—never reading position.</p></article>
                <article class="panel"><span class="text-2xl">📅</span><h3 class="mt-3 font-black">Google Calendar</h3><p class="mt-2 text-sm leading-relaxed text-slate-500">Bring read-only calendar events into the correct day and see activity density at a glance in week or month view.</p></article>
                <article class="panel"><span class="text-2xl">✅</span><h3 class="mt-3 font-black">Tasks and notes</h3><p class="mt-2 text-sm leading-relaxed text-slate-500">Record medication, walks, study, groceries, photos, recurring events, and longer notes with searchable emojis.</p></article>
                <article class="panel"><span class="text-2xl">💬</span><h3 class="mt-3 font-black">Reflection and search</h3><p class="mt-2 text-sm leading-relaxed text-slate-500">Review a complete daily timeline and use the assistant to ask questions or prepare changes for your approval.</p></article>
            </div>
        </section>

        <section id="demo" class="mx-auto max-w-7xl scroll-mt-4 space-y-5 p-4 sm:p-6 lg:p-8">
            <div id="demo-section-heading" class="flex min-w-0 flex-wrap items-end gap-3"><div id="demo-section-heading-copy" class="min-w-0"><p class="text-xs font-bold uppercase tracking-[.2em] text-emerald-600">Live simulation</p><h2 class="break-words text-2xl font-black sm:text-3xl">An ordinary week, all in one place</h2></div><div id="demo-privacy-message" class="min-w-0 max-w-md rounded-xl bg-emerald-50 px-3 py-2 text-xs text-emerald-900 dark:bg-emerald-950 dark:text-emerald-200 sm:ml-auto"><strong>Your private demo:</strong> an opaque cookie reconnects this browser to its own guest account. Other visitors cannot see these entries.</div></div>
            ...
            <div id="demo-workspace-layout" class="grid gap-5 lg:grid-cols-[minmax(0,1fr)_21rem]">
                ...
                <aside class="space-y-4">
                        <section class="panel lg:sticky lg:top-4"><p class="text-xs font-bold uppercase tracking-wider text-indigo-600">Try the real thing</p><h3 class="mt-1 text-xl font-black">Add to this day</h3><p class="mt-1 text-sm text-slate-500">Choose an emoji and time in the same side editor used by the signed-in app.</p><button type="button" class="btn mt-4 w-full" data-composer-open data-default-time="{{ $day->isToday() ? now()->format('H:i') : '12:00' }}">Write a demo note</button><div id="demo-feature-list" class="mt-5 border-t border-slate-200 pt-4 dark:border-slate-800"><p class="text-sm font-bold">Try it here</p><ul class="mt-2 space-y-2 text-sm text-slate-500"><li>😀 Search emojis by category</li><li>🕐 Set a precise entry time</li><li>✏️ Edit and autosave entries</li><li>📷 Preview attached photos</li></ul></div><div id="demo-source-list" class="mt-5 border-t border-slate-200 pt-4 dark:border-slate-800"><p class="text-sm font-bold">Sources in this timeline</p><ul class="mt-2 space-y-2 text-sm text-slate-500"><li>📝 Notes and recurring tasks</li><li>📅 Google Calendar events</li><li>🖥️ Desktop programs</li><li>🌐 Desktop and mobile browsing</li><li>📖 Manual Kindle reading</li></ul></div></section>
                </aside>
            </div>
        </section>
