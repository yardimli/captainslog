                    ...
                    @foreach($log->blocks as $block)
                        ...
                        <div class="timeline-item flex min-w-0 items-start gap-3">
                            ...
                            <article class="panel group min-w-0 flex-1">
                                <div class="demo-block-label mb-3 flex items-start gap-3"><span class="rounded-lg bg-slate-100 px-2 py-1 text-xs font-bold uppercase text-slate-600 dark:bg-slate-800 dark:text-slate-300">{{ str_replace('_',' ', $block->type) }}</span></div>
